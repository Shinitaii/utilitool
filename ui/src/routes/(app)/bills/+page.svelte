...
<div class="space-y-6">
		...
		<div class="rounded-lg border border-gray-200 bg-white p-6">
			...
			<div class="space-y-6">
				...
				<div>
					...
					<div
						class="max-h-64 space-y-2 overflow-y-auto rounded border border-gray-300 bg-gray-50 p-3"
					>
					...
					<div>
						...
						<div class="mt-4 rounded bg-yellow-50 p-3">
							<p class="text-sm font-semibold text-yellow-900">
								Total Consumption: {getRunningTotal().toFixed(2)} / {reviewForm.billing_consumption.toFixed(
									2
								)}
							</p>
			...
			<div class="mt-6 flex gap-3">
				...
				<button
					onclick={() => (step = 3)}
					disabled={Object.keys(reviewForm.billing_ids).length === 0 ||
						!isWithinTolerance() ||
						isLoading}
	...
	{#if step === 3 && ocrResult}
		<div class="rounded-lg border border-gray-200 bg-white p-6">
			...
			<div class="space-y-4 rounded bg-gray-50 p-4">
				<div class="grid grid-cols-2 gap-4">
					<div>
				...
				<div class="border-t border-gray-300 pt-4">
					<p class="mb-2 text-sm font-semibold text-gray-700">
						Billings ({Object.keys(reviewForm.billing_ids).length})
					</p>
						...
						{#each Object.keys(reviewForm.billing_ids) as billingId (billingId)}
							<li>
								...
								<span class="font-mono"
									>{reviewForm.billing_ids[billingId]?.toFixed(2) || '0.00'}</span
								>
							</li>
						{/each}
					</ul>
