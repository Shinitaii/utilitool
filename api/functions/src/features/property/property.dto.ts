...
export const CreatePropertyBatchDTOSchema = z.array(CreatePropertyDTOSchema).min(1).max(10);
...
export const UpdatePropertyBatchDTOSchema = z.array(UpdatePropertyBatchItemSchema).min(1).max(10);
